...
public class MyReversiPlayerCoarse extends ReversiPlayer {
    ...
    public void opponentsMove(Position position) {
        ...
        if(root.moves.size()-root.children.size()>0){
            ...
            System.out.println("IS PRUNED: "+root.pruned);
    ...
    public static void main(String[] args) {
        PlayerProtocol player = new ReversiPlayerProtocol(new MyReversiPlayerCoarse());
        player.gameStart();
    }
}
